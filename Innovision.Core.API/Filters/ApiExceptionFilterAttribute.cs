...
namespace Innovision.Core.Filters;
        ...
        _exceptionHandlers = new Dictionary<Type, Action<ExceptionContext>>
            {
                ...
                { typeof(FileServiceException), HandleCustomException },
                { typeof(GameApiException), HandleCustomException },
                { typeof(CoreIdentityApiException), HandleCustomException },
                { typeof(NameExistsException), HandleCustomException },
            };
    }
