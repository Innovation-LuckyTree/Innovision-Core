    ...
    public class CurrentAccountDto : IMapFrom<Account>
    {
        ...
        public void Mapping(Profile profile)
        {
            profile.CreateMap<Account, CurrentAccountDto>()
                ...
                .ForMember(t => t.PresentRegion, f => f.MapFrom(src => src.PresentAddress.Region))
                .ForMember(t => t.PresentProvince, f => f.MapFrom(src => src.PresentAddress.Province))
                .ForMember(t => t.PresentMunicipality, f => f.MapFrom(src => src.PresentAddress.Municipality))
                .ForMember(t => t.PresentBarangay, f => f.MapFrom(src => src.PresentAddress.Barangay))
                .ForMember(t => t.PresentStreetOrPurok, f => f.MapFrom(src => src.PresentAddress.StreetOrPurok))
