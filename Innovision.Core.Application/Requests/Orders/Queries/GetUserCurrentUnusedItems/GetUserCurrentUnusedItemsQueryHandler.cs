...
public class GetUserCurrentUnusedItemsQueryHandler : IRequestHandler<GetUserCurrentUnusedItemsQuery, OrderItemVm>
{
    ...
    public async Task<OrderItemVm> Handle(GetUserCurrentUnusedItemsQuery request, CancellationToken cancellationToken)
    {
