...
{
    public class PlayerActivityDto : IMapFrom<PlayerActivity>
    {
        ...
        {
            profile.CreateMap<PlayerActivity, PlayerActivityDto>()
                ...
                .ForMember(t => t.ExcludeDateTime, f => f.MapFrom(src => src.ExcludeDateTime))
