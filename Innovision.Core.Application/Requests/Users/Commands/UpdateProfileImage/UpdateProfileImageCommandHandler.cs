...
public class UpdateProfileImageCommandHandler(ICoreDbContext dbContext, ICurrentUserService currentUserService) : IRequestHandler<UpdateProfileImageCommand, ApiResponse<bool>>
{
    ...
    public async Task<ApiResponse<bool>> Handle(UpdateProfileImageCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            account.ProfilePath = request.ProfilePath;
